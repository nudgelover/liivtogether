	...
	<div class="container">
		<div class="row">
			...
			<div style="margin-bottom: 10px;">
				...
				<label for="myReviewOnly" id="labelMyReviewOnly">내가 작성한 후기
					모아보기</label>
			</div>
			...
			<c:forEach var="item" items="${reviewcontent}">
				...
				<div class="review">
					...
					<c:if test="${item.custId==logincust.custId}">
						<button class="btnDel" onclick="delReview('${item.reviewId}')"><img style="width: 1.5em;" src="https://cdn-icons-png.flaticon.com/512/484/484560.png"></button>
					</c:if>
						<div class="row">
	...
	anychart.onDocumentReady(function() {
		...
		chart.data(data, {
			...
			ignoreItems : [ "통해", "하면서", "수", "해도", "더", "어떻게", "그리고", "그런데",
					...
					"때문에", "무엇", "어떻게", "어디", "언제", "왜", "어떤", "그럼","게","들을","것","대해서",
					"아니요", "네", "모두", "나", "너", "그", "그녀", "우리", "그들", "이",
					"저", "누가", "무슨", "무엇", "얼마나", "몇", "더", "많이", "적게", "매우",
					"정말", "너무", "그래서", "그러므로", "그러면", "또한", "물론", "아마도", "다시",
					"곧", "지금", "이제", "그때", "전에", "바로", "조금", "많이", "딱", "바로",
					"먼저", "다음", "때", "후에", "마지막", "아직", "높이"
			// 필요에 따라 추가할 수 있습니다.
			]
		});
