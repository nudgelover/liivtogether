		...
		<div class="row justify-content-center">
			...
			<div id="joinBox"
				...
				<div style="display: block;" class="join-tab-content" id="tab1">
					<h3>💡선택하시는 상품의 정보입니다.</h3>
					<img style="width: 90%" src="/uimg/${esgshop.imageMain}">
					<p style="font-size: 1.5rem;">상품명 : ${esgshop.title}</p>
					<p>
						진행날짜 : <span id="esgshop-date"></span>
					</p>
					<p>
						필요코인 : <img style="width: 30px;"
							src="/assets/img/payment/starcoin.png">
						${esgshop.rewardCoin} 개
					</p>
				</div>
				...
				<div class="join-tab-content" id="tab2">
					...
					<div class="mt-6" style="text-align: left;">
						...
						<p>당사는 이 상품 신청을 위해 아래의 개인 정보를 수집하고자 합니다.</p>
						<ul>
							<li>성명</li>
						...
						<ul>
							<li>상품 참가 신청 및 관리</li>
							<li>상품 안내 및 업데이트 제공</li>
							<li>상품 관련 서비스 제공 및 운영</li>
						</ul>

						<p>
							<strong>3. 개인 정보 보유 기간</strong>
						</p>
						<p>수집한 개인 정보는 상품 종료 후 최대 5년까지 보관됩니다. 보유 기간 이후에는 해당 정보를 즉시
							파기합니다.</p>
						...
						<p>개인 정보의 수집 및 이용에 대한 동의는 상품 참가 신청을 위해 필요한 사항입니다. 동의를 거부하실 경우
							상품 참가 신청이 제한될 수 있습니다.</p>
...
<input type="hidden" id="contents_id" value="${esgshop.esgId}">
<input type="hidden" id="agreeornot" value="0">
<input type="hidden" id="mount" value="${esgshop.rewardCoin}">
...
<script>
	...
	var payBtnClickListener = function() {
	    var starCoin = ${esgshop.rewardCoin};
	    var text = "<span style='font-size: 1.4rem;'>" + starCoin + " 스타코인이 소요됩니다.</span></br>신청하신 상품은 취소하실 수 없습니다. 정말로 결제하시겠습니까?";
	...
	function goToJoinComplete(custId, contentsId) {
	    const url = 'http://localhost/esgshop/join-complete'
